    ...
    VlanPortDiscovery
{
    ...
    public function discoverTransceivers(): Collection
    {
        ...
        return \SnmpQuery::walk('HUAWEI-ENTITY-EXTENT-MIB::hwOpticalModuleInfoTable')->mapTable(function ($data, $entIndex) use ($entityToIfIndex) {
            ...
            if (isset($data['HUAWEI-ENTITY-EXTENT-MIB::hwEntityOpticalMode']) && $data['HUAWEI-ENTITY-EXTENT-MIB::hwEntityOpticalMode'] == 1) {
                return null;
            }
            ...
            if (empty($data['HUAWEI-ENTITY-EXTENT-MIB::hwEntityOpticalVenderName']) && empty($data['HUAWEI-ENTITY-EXTENT-MIB::hwEntityOpticalVenderPn']) && empty($data['HUAWEI-ENTITY-EXTENT-MIB::hwEntityOpticalVendorSn']) && empty($data['HUAWEI-ENTITY-EXTENT-MIB::hwEntityOpticalVenderSn'])) {
            ...
            return new Transceiver([
                ...
                'serial' => $data['HUAWEI-ENTITY-EXTENT-MIB::hwEntityOpticalVendorSn'] ?? $data['HUAWEI-ENTITY-EXTENT-MIB::hwEntityOpticalVenderSn'] ?? null,
                'connector' => $connector,
                'revision' => null,
                'cable' => null,
                'distance' => $distance,
